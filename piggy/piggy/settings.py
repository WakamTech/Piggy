...
DB_PATH = os.environ.get('DB_PATH', 'postgres://avnadmin:AVNS_cGMq7VhLhsM_8RYEaNa@pg-f9a90ec-williammerveilleaklamavo-6f0f.e.aivencloud.com:12827/defaultdb?sslmode=require')
...
#DATABASES = {
#    'default': {
#        'ENGINE': 'django.db.backends.sqlite3',  # Ligne manquante
